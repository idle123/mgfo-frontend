...
var BrowserCacheManager = class extends CacheManager {
  ...
  async removeAccountOldSchema(accountKey, rawObject, credentialSchema, correlationId) {
    ...
    const homeAccountId = decryptedData == null ? void 0 : decryptedData.homeAccountId;
    if (homeAccountId) {
...
var PlatformAuthInteractionClient = class extends BaseInteractionClient {
  ...
  async handleNativeResponse(response, request, reqTimestamp) {
    ...
    await this.cacheAccount(baseAccount, this.correlationId, AuthToken_exports.isKmsi(idTokenClaims));
...
var TokenCache = class {
  ...
  async loadAccount(request, clientInfo, correlationId, idTokenClaims, authority) {
    ...
    if (request.account) {
      ...
      await this.storage.setAccount(accountEntity, correlationId, AuthToken_exports.isKmsi(idTokenClaims || {}));
    ...
    await this.storage.setAccount(cachedAccount, correlationId, AuthToken_exports.isKmsi(idTokenClaims || {}));
...
var StandardController = class _StandardController {
  ...
  async hydrateCache(result, request) {
    ...
    await this.browserStorage.setAccount(accountEntity, result.correlationId, AuthToken_exports.isKmsi(result.idTokenClaims));
...
function getPerfMeasurementModule() {
  ...
  try {
    ...
    if (Number(perfEnabled) === 1) {
      return import("./BrowserPerformanceMeasurement-GRQ4MFQE.js");
    }
  } catch (e) {
  }
  return void 0;
